...
void Skybox::createObject()
{
    ...
    //Cube front from top left clockwise: 3,6,7,2. Backside parallel points: 1,5,4,0
    positions.push_back(glm::vec3(-1,-1,-1) *1.f); // 0 -> 0
    positions.push_back(glm::vec3(-1, 1, -1)*1.f); // 1 -> 1
    positions.push_back(glm::vec3(-1,-1, 1) *1.f); // 4 -> 2
